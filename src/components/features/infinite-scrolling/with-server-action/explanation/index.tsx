  ...
  return (
    <div className="space-y-[20px]">
      ...
      <p>
        ...
        <TextHighlight text="InfiniteScrollWSA" /> client component to later
        on fetch the pokemon.
      </p>
      <p>
        We pass the initial pokemon list to the{" "}
        <TextHighlight text="InfiniteScrollWSA" /> component as a children
        as that is the only way a client component can render a server
        component. In the <TextHighlight text="InfiniteScrollWSA" />{" "}
