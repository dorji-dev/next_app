...
const Card = (
  ...
  ref={ref}
  className={cn(
    "rounded-[12px] border bg-card text-card-foreground shadow-sm hover:shadow-md transition-all duration-300",
    className
  )}
  {...props}
/>);
...
const CardTitle = (
  ...
  ref={ref}
  className={cn("font-semibold text-[20px] leading-none tracking-tight", className)}
  {...props}
/>);
